...
sealed interface ConnectNotificationState {
    data object ShowTunnelStateNotificationBlocked :
        ConnectNotificationState

    data class ShowTunnelStateNotificationError(val error: ErrorState) :
        ConnectNotificationState
    data class ShowVersionInfoNotification(val versionInfo: VersionInfo) : ConnectNotificationState
    data class ShowAccountExpiryNotification(val expiry: DateTime) :
        ConnectNotificationState
